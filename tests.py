...
from ultimatejobweb.API_FB import Manipulation_FB
...
def test_api_urls():
    ...
    assert Manipulation_FB.extract_jobs_url() == expected_output_urls, "The tests for URLs were successful"
...
def test_api_titles():
    ...
    assert Manipulation_FB.extract_jobs_title() == expected_output_titles, "The tests for URLs were successful"
