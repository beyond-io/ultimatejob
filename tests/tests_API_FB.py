...
def test_api_titles():
    ...
    expected_output_titles = ['Engineering Manager - Malware Analysis Infrastructure',
                              'Software Engineer, Android', 'Software Engineer, Machine Learning',
                              'Manager, Software Engineering (AR Commerce)', 'Android Software Engineer',
                              'Industrial Design Architect - FRL', 'Software Engineer, Vision',
                              'Battery System Engineer', 'Product Designer, Portal Product Lines',
                              'Software Engineer, AI (EMEA)', 'Instructional Design Lead',
                              'Research Scientist, Vision', 'Web Manager, Facebook for Business',
                              ...
                              'Data Scientist Manager, Fraud', 'Product Manager, Research Platform ',
                              'Software Engineer, AI (EMEA)', 'Client Solutions Manager, Philippines',
                              'Hardware Systems Engineer, Compute', 'Production Engineer']
